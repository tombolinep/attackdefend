...
class ShopTile:
    def __init__(self, x, y, width, height, title, description, price):
        ...
        self.buy_box_rect = pygame.Rect(self.rect.left, self.rect.bottom - 40, self.rect.width - 230, 40)
    ...
    def _draw_texts(self, screen):
        ...
        wrapped_description = self._wrap_text(self.description, description_font, self.rect.width - 2 * INTERNAL_MARGIN)
        ...
        price_surface = price_font.render(f"Price: {self.price} coins", True, (255, 255, 255))
    ...
    def is_hovered(self, pos):
        return self.buy_button.collidepoint(pos)

    def get_buy_box_rect(self):
        return self.buy_box_rect
